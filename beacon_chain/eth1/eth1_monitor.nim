...
proc getBlockProposalData*(chain: var Eth1Chain,
  ...
  if latestBlock == nil:
    info "PIETJE 2: Latest candidate block is nil?"
  else:
    info "PIETJE 2: Latest candidate block", latestBlockHash = latestBlock.hash
...
func earliestBlockOfInterest(m: Eth1Monitor): Eth1BlockNumber =
  m.latestEth1BlockNumber - SLOTS_PER_ETH1_VOTING_PERIOD - m.cfg.ETH1_FOLLOW_DISTANCE - votedBlocksSafetyMargin
